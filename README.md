...
## About
<p>
    This is decentralized application (dapp) for generating sum of squares powered by <a href="https://docs.cartesi.io/cartesi-rollups/1.3/">cartesi</a> rollups technology.
</p>
...
1. Clone this repo
   ```sh
   git clone https://github.com/Fikkay/Cartesi-Dapp.git
   ```
...
#### Advanced handlers
```
description — generate a sum of squares.
