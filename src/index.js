...
const sumOfSquares = (firstNum, secondNum) => {
  let sum = 0;
...
async function handle_advance(data) {
  ...
  const result = sumOfSquares(firstNumber, secondNumber);
...
async function handle_inspect(data) {
  ...
  const responseObject = "Inspect route not implemented for sum of squares of numbers";
